...
namespace Mediapipe.Unity
{
  public class PoseLandmarkerResultAnnotationController : AnnotationController<MultiPoseLandmarkListWithMaskAnnotation>
  {
    ...
    public void SetBodyPartsMask(PoseLandmarkListAnnotation.BodyParts bodyPartsMask)
    {
      _bodyPartsMask = bodyPartsMask;
    }
    ...
    {
      annotation.SetFaceCircleOptions(drawFaceCircle, faceCircleColor, faceCircleWidth, faceCirclePadding, faceCircleRadiusScale, faceCircleOffset);
    }
    ...
    protected override void SyncNow()
    {
      ...
      {
        isStale = false;
        annotation.Draw(_currentTarget.poseLandmarks, _bodyPartsMask, _visualizeZ);
      }
    }
  }
}
