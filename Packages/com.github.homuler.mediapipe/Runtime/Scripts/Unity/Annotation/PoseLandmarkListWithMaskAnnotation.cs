...
#pragma warning restore IDE0065
  ...
  public sealed class PoseLandmarkListWithMaskAnnotation : HierarchicalAnnotation
  {
    ...
    {
      _poseLandmarkListAnnotation.SetFaceCircleOptions(drawFaceCircle, faceCircleColor, faceCircleWidth, faceCirclePadding, faceCircleRadiusScale, faceCircleOffset);
    }
    ...
    public void Draw(mptcc.NormalizedLandmarks poseLandmarks, PoseLandmarkListAnnotation.BodyParts mask, bool visualizeZ = false)
    {
    ...
    {
      Draw(poseLandmarks, PoseLandmarkListAnnotation.BodyParts.All, visualizeZ);
    }
  }
}
